...
class ViewController: UIViewController {
    ...
    @IBAction func lampOff(_ sender: UIButton) {
        if isLampOn {
            ...
            let offAction = UIAlertAction(title: "네", style: UIAlertAction.Style.default, handler: {ACTION in self.imageLamp.image = self.imgOff
                self.isLampOn = false}) //익명 함수
